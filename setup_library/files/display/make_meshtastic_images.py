...
make("start_10_starting_meshtastic.jpg", "Meshstastic Starting", color=GREEN)
make("start_10_meshtastic_started.jpg", "Meshtastic Started", color=GREEN)
make("start_10_meshtastic_failed.jpg", "Meshtastic Failed", color=RED)
